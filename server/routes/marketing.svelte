...
<div class="bg-white font-sans">
  <header class="bg-white relative z-20 px-6">
    ...
    >
      <a
        href="/marketing"
        class="w-64 h-full inline-block py-4 flex items-center font-black text-lg">
        Marketing Co
        <!-- <img loading="lazy"  alt="alt"  src="http://placehold.it/280x160" class="h-full w-auto" /> -->
      </a>

      <ul class="hidden md:flex flex-1 h-full justify-end items-center text-sm">
        <li><a href="/marketing" class="hover:opacity-75">Home</a></li>
        <li class="ml-6"><a href="/marketing">About Us</a></li>
        <li class="ml-6"><a href="/marketing">Products</a></li>
        <li class="ml-6"><a href="/marketing">Services</a></li>
        <li class="ml-6">
          <form class="relative" data-np-checked="1">
            <input
              type="search"
      ...
      <a href="/marketing" class="md:hidden">
        <img
          loading="lazy"
          alt="alt"
          class="w-8 h-auto"
  ...
  <div class="w-full bg-blue-600">
    <div class="w-full h-full relative flex items-center justify-center py-24">
      ...
      <div class="px-6 max-w-4xl relative z-10 text-center">
        ...
        >Excepteur sint occaecat cupidatat non</h1>
        <h2
          class="text-lg md:text-2xl font-condensed text-white leading-tight mb-8"
        >Pretium quam vulputate dignissim suspendisse in est ante</h2>
        <a
          href="/marketing"
    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap">
        <div class="mb-12 lg:mb-0 w-full lg:flex-1">
          ...
          >Ut enim ad minim veniam, quis nostrud.</h2>
          ...
          <ul class="py-6 mb-6">
            <li class="flex items-center mb-6">
              ...
              <div class="pl-5">
                ...
                >At tellus at urna condimentum.</h4>
                <p
    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap justify-center items-center">
        ...
        <div class="w-full lg:flex-1 max-w-2xl text-sm lg:pl-12 text-gray-800">
          ...
          <p class="mb-3">
            Ac auctor augue mauris augue neque gravida in fermentum et. Nunc id
            cursus metus aliquam eleifend mi in nulla posuere. Erat velit
            scelerisque in dictum non. Ut enim blandit volutpat maecenas
            volutpat. Blandit massa enim nec dui nunc mattis enim. Cursus risus
          ...
          <p class="mb-3">
            ...
            aenean et tortor at risus viverra. Sed odio morbi quis commodo odio
            aenean sed. Lobortis scelerisque fermentum dui faucibus in. Leo urna
            molestie at elementum eu facilisis. Eu volutpat odio facilisis
            mauris sit amet massa vitae.
          </p>
          <p>
            Tristique senectus et netus et malesuada fames ac turpis egestas.
            Blandit volutpat maecenas volutpat blandit aliquam etiam erat velit
            scelerisque. Pharetra massa massa ultricies mi quis.
          </p>
        </div>
      </div>
    </div>
    ...
    <footer class="container mx-auto">
      <div class="flex flex-col md:flex-row">
        <div class="md:w-1/4 flex flex-col mb-12 md:mb-0">
          ...
          <a href="/marketing" class="text-sm text-gray-800 py-1"
            >Privacy Policy</a
          >
          <a href="/marketing" class="text-sm text-gray-800 py-1"
            >Terms &amp; Conditions</a
        ...
        <div class="md:w-1/4 flex flex-col mb-12 md:mb-0">
          ...
          >
          <a href="/marketing" class="text-sm text-gray-800 py-1">History</a>
        </div>
        <div class="md:w-1/4 flex flex-col mb-12 md:mb-0">
          <h4 class="font-condensed pb-4">Services</h4>
          <a href="/marketing" class="text-sm text-gray-800 py-1">Buildings</a>
          <a href="/marketing" class="text-sm text-gray-800 py-1"
            >Construction</a
          >
        </div>
        <div class="md:w-1/4 flex flex-col mb-12 md:mb-0">
          ...
          <a
            href="/marketing"
            target="_blank"
            class="text-sm text-gray-800 py-1">Office Location</a
          >
          <a
            href="/marketing"
            target="_blank"
            class="text-sm text-gray-800 py-1">Contact Us</a
          >
        </div>
      </div>
